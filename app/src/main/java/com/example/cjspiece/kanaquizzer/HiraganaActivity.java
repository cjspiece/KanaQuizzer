...
public class HiraganaActivity extends AppCompatActivity {
    private HiraganaLib hiraLib = new HiraganaLib();
    private int score = 0;
    ...
    private void selectItem(int position) {
        ...
        if (position == 0) {
            ...
            if(this.getClass() != HiraganaActivity.class) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerList.setOnItemClickListener(new HiraganaActivity.DrawerItemClickListener());
    ...
    private void getNewKana() {
        ...
        kanaImg.setText(hiraLib.getNewKana());
    }
}
