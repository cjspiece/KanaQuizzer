...
public class HiraganaChartActivity extends AppCompatActivity {
    ...
    private void selectItem(int position) {
        ...
        if (position == 0) {
            ...
            if(this.getClass() != HiraganaChartActivity.class) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hiragana_chart);
        ...
        drawerList.setOnItemClickListener(new HiraganaChartActivity.DrawerItemClickListener());
        ...
        // Setup the gridview
        GridView gridview = (GridView)findViewById(R.id.activity_kana_chart);
        gridview.setAdapter(new HiraAdapter(this));

        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(HiraganaChartActivity.this, myLib.getAnswerAt(position) , Toast.LENGTH_SHORT).show();
            }
        });
    }
}
